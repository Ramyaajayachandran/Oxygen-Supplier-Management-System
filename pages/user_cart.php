              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <option value="Coimbatore City">Coimbatore</option>
                      <option value="Chennai City">Chennai</option>
                      <option value="Bangalore City">Bangalore</option>
                      <option value="Pondicherry City">Pondicherry</option>
                      <option value="Pune City">Pune</option>
                      <option value="Chandigargh City">Chandigargh</option>
                      <option value="Delhi City">Delhi</option>
                      <option value="Agra City">Agra</option>
                      <option value="Mysore City">Mysore</option>
                      <option value="Ahmedabad City">Ahmedabad</option>
                      <option value="Hyderabad City">Hyderabad</option>
                      <option value="Surat City">Surat</option>
                      <option value="Trivandrum City">Trivandrum</option>
                      <option value="Shimla City">Shimla</option>
                      <option value="Jaipur City">Jaipur</option>
                      <option value="Varanasi City">Varanasi</option>
                      </select>  
                      </div>
