...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="slid-02.jpg">
    <link rel="icon" type="image/png" href="slid-02.jpg">
...
<body class="login-page sidebar-collapse">
    ...
    <div class="page-header" >
        <div class="page-header-image" style="background-image:url(slid-02.jpg)"></div>
        <div class="container">
