...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="admin6.jpeg">
    <link rel="icon" type="image/png" href="admin6.jpeg">
...
<body class="index-page sidebar-collapse">
    ...
    <div class="wrapper">
        <div class="page-header clear-filter">
            <div class="page-header-image" data-parallax="true" style="background-image: url('admin6.jpg');">
            
                <div class="container">
                    <div class="content-center brand">
                        
                        <br><br>
                        <b><h3>OXYGEN SUPPLIER MANAGEMENT SYSTEM.</h3></b>
                    </div>
                </div>
            </div>
        </div>
