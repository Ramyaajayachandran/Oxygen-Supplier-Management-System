...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="admin4.jfif">
    <link rel="icon" type="image/png" href="admin4.jfif">
...
<body class="profile-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                ...
                <button class="navbar-toggler navbar-toggler" type="button" data-toggle="collapse"  aria-expanded="false" aria-label="Toggle navigation">
    ...
    <!-- End Navbar -->
        ...
        <div class="wrapper" filter-color="black">
            <div class="page-header page-header-small">
            <div class="page-header-image" data-parallax="true" style="background-image: url('admin4.jfif');"></div>
                <div class="container">
