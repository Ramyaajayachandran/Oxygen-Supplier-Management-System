...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="slid-03.jpg">
    <link rel="icon" type="image/png" href="slid-03.jpg">
...
?>
    ...
    <div class="page-header" >
        <div class="page-header-image" style="background-image:url(slid-03.jpg)"></div>
        <div class="container">
