...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="admin1.jpg">
    <link rel="icon" type="image/png" href="admin1.jpg">
...
?>
    ...
    <div class="page-header" filter-color="black">
        <div class="page-header-image" style="background-image:url(admin1.jpg)"></div>
        <div class="container">
