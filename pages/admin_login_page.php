...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="admin2.jpg">
    <link rel="icon" type="image/png" href="admin2.jpg">
...
<body class="login-page sidebar-collapse">
    ...
    <div class="page-header" >
        <div class="page-header-image" style="background-image:url(admin2.jpg)"></div>
        <div class="container">
