...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="slid-01.jpg">
    <link rel="icon" type="image/png" href="slid-01.jpg">
...
<body class="index-page sidebar-collapse" >
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <h5><a href="../website/Electicks Website/page/home.php" class="navbar-brand" rel="tooltip"  data-placement="bottom" target="">
                    OXYSTORE
                </a></h5>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="slid-02.jpg">
                <ul class="navbar-nav">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" rel="tooltip" title="Follow us on Twitter" data-placement="bottom" href="https://twitter.com" target="_blank">
                            ...
                            <h6><p class="d-lg-none d-xl-none">Twitter</p></h6>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" rel="tooltip" title="Like us on Facebook" data-placement="bottom" href="https://www.facebook.com" target="_blank">
                            <i class="fa fa-facebook-square"></i>
                            <h6><p class="d-lg-none d-xl-none">Facebook</p></h6>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" rel="tooltip" title="Follow us on Instagram" data-placement="bottom" href="https://www.instagram.com" target="_blank">
                            <i class="fa fa-instagram"></i>
                            <h6><p class="d-lg-none d-xl-none">Instagram</p></h6>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <div class="wrapper">
        <div class="page-header clear-filter">
            <div class="page-header-image" data-parallax="true" style="background-image: url('slid-01.jpg');">
            
                <div class="container">
                    <div class="content-center brand">
                        <!--<img src="./assets/img/elogo.png" alt="Circle Image" class="rounded-circle">-->
                        <br><br>
                        <h2>Oxygen Supplier Management System.</h2>
                    </div>
                </div>
            </div>
        </div>
